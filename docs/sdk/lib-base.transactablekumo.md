...
|  [depositKUSDInStabilityPool(amount)](./lib-base.transactablekumo.depositkusdinstabilitypool.md) | Make a new Stability Deposit, or top up existing one. |
...
|  [openTrove(params, asset, tokenAmount, maxBorrowingRate)](./lib-base.transactablekumo.opentrove.md) | Open a new Trove by depositing collateral and borrowing KUSD. |
...
|  [transferCollateralGainToTrove(asset)](./lib-base.transactablekumo.transfercollateralgaintotrove.md) | Transfer [collateral gain](./lib-base.stabilitydeposit.collateralgain.md) from Stability Deposit to Trove. |
