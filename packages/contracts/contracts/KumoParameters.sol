...
contract KumoParameters is IKumoParameters, Ownable, CheckContract {
    ...
    uint256 constant public MCR_DEFAULT = 1100000000000000000; // 110%
    // Critical system collateral ratio. If the system's total collateral ratio (TCR) falls below the CCR, Recovery Mode is triggered.
    uint256 constant public CCR_DEFAULT = 1500000000000000000; // 150%
	// Minimum amount of net KUSD debt a trove must have
    uint256 constant public MIN_NET_DEBT_DEFAULT = 1800e18;
    // uint256 constant public MIN_NET_DEBT = 0; 
    uint256 constant public PERCENT_DIVISOR_DEFAULT = 200; // dividing by 200 yields 0.5%
