...
contract KumoParameters is IKumoParameters, Ownable, CheckContract {
    ...
    uint256 public constant KUMO_GAS_COMPENSATION_DEFAULT = 30 ether;
	...
	// 	// KUSD_GAS_COMPENSATION = KUMO_GAS_COMPENSATION_DEFAULT;
	...
	// 	// setKUMOGasCompensation(gasCompensation);
	...
	// // function setKUMOGasCompensation(uint256 gasCompensation)
	// // 	public
	// // 	override
	// // 	onlyOwner
	// // 	safeCheck("Gas Compensation", gasCompensation, 1 ether, 400 ether)
	// // {
	// // 	uint256 oldGasComp = KUSD_GAS_COMPENSATION;
	// // 	KUSD_GAS_COMPENSATION = gasCompensation;
