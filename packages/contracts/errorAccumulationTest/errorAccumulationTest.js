...
contract("TroveManager", async accounts => {
  ...
  beforeEach(async () => {
    ...
    erc20 = await deploymentHelper.deployERC20Asset("Carbon Token X", "CTX");
  ...
  it("11 accounts with random coll. 1 liquidation. 10 accounts do Trove operations (apply rewards)", async () => {
    ...
    await borrowerOperations.openTrove(0, dec(170, 18), accounts[0], {
      from: accounts[0],
      value: dec(1, "ether")
    });
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    console.log(
      `Accumulated KUSDDebt difference between Active and Default Pools is: ${totalKUSDDebtPoolDifference}`
    );
  });
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    console.log(
      `KUSDDebt difference between total pending rewards and DefaultPool: ${KUSDDebtRewardDifference} `
    );
  });
  ...
  */
  ...
  it("11 accounts with random ETH and proportional KUSD (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    await th.openTrove_allAccounts_randomETH_ProportionalKUSD(
      1,
      2,
      accounts.slice(0, 11),
      contracts,
  ...
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    console.log(
      `KUSDDebt difference between total pending distribution rewards and DefaultPool: ${KUSDDebtRewardDifference} `
    );
  });
