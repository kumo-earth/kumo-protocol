...
const TroveManager = artifacts.require("./TroveManagerDiamond.sol");
...
const getAddresses = contracts => {
  return {
    ...
    KUSDToken: contracts.kusdToken.address,
...
const connectContracts = async (contracts, addresses) => {
  ...
  await contracts.troveManager.setKUSDToken(addresses.KUSDToken);
