...
$ hardhat test
  ...
  Contract: BorrowerOperations
    Without proxy
      ...
      ✓ withdrawKUSD(): borrowing at non-zero base rate sends KUSD fee to LQTY staking contract (1004ms)
      ✓ withdrawKUSD(): borrowing at non-zero base records the (drawn debt + fee) on the Trove struct (923ms)
      ✓ withdrawKUSD(): Borrowing at non-zero base rate increases the LQTY staking contract KUSD fees-per-unit-staked (986ms)
      ...
      ✓ adjustTrove(): borrowing at non-zero base rate sends KUSD fee to LQTY staking contract (889ms)
      ✓ adjustTrove(): borrowing at non-zero base records the (drawn debt + fee) on the Trove struct (1013ms)
      ✓ adjustTrove(): Borrowing at non-zero base rate increases the LQTY staking contract KUSD fees-per-unit-staked (837ms)
      ✓ adjustTrove(): Borrowing at non-zero base rate sends requested amount to the user (895ms)
      ✓ adjustTrove(): Borrowing at zero base rate changes KUSD balance of LQTY staking contract (783ms)
      ✓ adjustTrove(): Borrowing at zero base rate changes LQTY staking contract KUSD fees-per-unit-staked (881ms)
      ...
      ✓ openTrove(): borrowing at non-zero base rate sends KUSD fee to LQTY staking contract (923ms)
      ✓ openTrove(): borrowing at non-zero base records the (drawn debt + fee  + liq. reserve) on the Trove struct (865ms)
      ✓ openTrove(): Borrowing at non-zero base rate increases the LQTY staking contract KUSD fees-per-unit-staked (794ms)
      ✓ openTrove(): Borrowing at non-zero base rate sends requested amount to the user (832ms)
      ✓ openTrove(): Borrowing at zero base rate changes the LQTY staking contract KUSD fees-per-unit-staked (602ms)
...
issuance fraction after: 949066037374286
  ...
  Contract: LQTYStaking revenue share tests
    ...
    ✓ KUSD fee per LQTY staked increases when a redemption fee is triggered and totalStakes > 0 (1757ms)
    ✓ KUSD fee per LQTY staked doesn't change when a redemption fee is triggered and totalStakes == 0 (1705ms)
...
totalLQTYIssued_2: 30370113195977152000000
      ...
      ✓ withdrawFromSP(): Several deposits of 100 KUSD span one scale factor change. Depositors withdraw correct LQTY gains (6075ms)
      ...
      ✓ withdrawFromSP(): Several deposits of 10k KUSD span one scale factor change. Depositors withdraw correct LQTY gains (4788ms)
