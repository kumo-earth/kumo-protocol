...
contract('Gas compensation tests', async accounts => {
  ...
  it('_getCollGasCompensation(): returns 0.5% of collaterall when 0.5% of collateral < $10 in value', async () => {
    ...
    -> Expect 0.5% of collaterall as gas compensation */
    const gasCompensation_1 = (await troveManager.getCollGasCompensation(assetAddress1, '9999000000000000000')).toString()
    ...
    /* ETH:USD price = 200
     ...
     -> Expect 0.5% of collaterall as gas compensation */
    const gasCompensation_2 = (await troveManager.getCollGasCompensation(assetAddress1, '55000000000000000')).toString()
    ...
    -> Expect 0.5% of collaterall as gas compensation */
    const gasCompensation_3 = (await troveManager.getCollGasCompensation(assetAddress1, '6092324088087235800')).toString()
  ...
  it('getCollGasCompensation(assetAddress1, ): returns 0.5% of collaterall when 0.5% of collateral = $10 in value', async () => {
    ...
    -> Expect 0.5% of collaterall as gas compensation */
    const gasCompensation = (await troveManager.getCollGasCompensation(assetAddress1, dec(10, 'ether'))).toString()
  ...
  it('getCollGasCompensation(): returns 0.5% of collaterall when 0.5% of collateral = $10 in value', async () => {
    ...
    const gasCompensation_1 = (await troveManager.getCollGasCompensation(assetAddress1, dec(100, 'ether'))).toString()
    ...
    const gasCompensation_2 = (await troveManager.getCollGasCompensation(assetAddress1, '10001000000000000000')).toString()
    ...
    const gasCompensation_3 = (await troveManager.getCollGasCompensation(assetAddress1, '37500000000000000000')).toString()
  ...
  it('getCompositeDebt(): returns (debt + 50) collateral = $10 in value', async () => {
    ...
    const compositeDebt = await troveManager.getCompositeDebt(assetAddress1, '123450000000000000000')
  ...
  it('getCompositeDebt(): returns (debt + 50) when 0.5% of collateral > $10 in value', async () => {
    ...
    const compositeDebt_1 = (await troveManager.getCompositeDebt(assetAddress1, dec(2000, 18))).toString()
    ...
    debt = 200 KUSD
    -> Expect composite debt = (200 + 200) = 400 KUSD  */
    const compositeDebt_2 = (await troveManager.getCompositeDebt(assetAddress1, dec(200, 18))).toString()
    ...
    const compositeDebt_3 = (await troveManager.getCompositeDebt(assetAddress1, dec(500, 18))).toString()
  ...
  it('getCurrentICR(): Incorporates virtual debt, and returns the correct ICR for new troves', async () => {
    ...
    await await openTrove({ asset: assetAddress1,ICR: toBN('1818181818181818181'), extraParams: { from: alice } })
    ...
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraParams: { from: bob } })
    ...
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(100, 18), extraParams: { from: flyn } })
    ...
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(3125, 15)), extraParams: { from: carol } })
    ...
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(4, 18)), extraParams: { from: dennis } })
    ...
    await await openTrove({ asset: assetAddress1,ICR: toBN('27028668628933700000'), extraParams: { from: erin } })
    ...
    await await openTrove({ asset: assetAddress1,ICR: toBN('1111111111111111111'), extraParams: { from: harriet } })
  ...
  it('Gas compensation from pool-offset liquidations. All collateral paid as compensation', async () => {
    ...
    // A-E open troves
    const { totalDebt: A_totalDebt } = await await openTrove({ asset: assetAddress1, ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(100, 18), extraParams: { from: alice } })
    const { totalDebt: B_totalDebt } = await await openTrove({ asset: assetAddress1, ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(200, 18), extraParams: { from: bob } })
    const { totalDebt: C_totalDebt } = await await openTrove({ asset: assetAddress1, ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(300, 18), extraParams: { from: carol } })
    await await openTrove({ asset: assetAddress1, ICR: toBN(dec(2, 18)), extraKUSDAmount: A_totalDebt, extraParams: { from: dennis } })
    await await openTrove({ asset: assetAddress1, ICR: toBN(dec(2, 18)), extraKUSDAmount: B_totalDebt.add(C_totalDebt), extraParams: { from: erin} })
    ...
    const liquidatorBalance_before_A = web3.utils.toBN(await erc20.balanceOf(liquidator))
    const A_GAS_Used_Liquidator = th.gasUsed(await troveManager.liquidate(assetAddress1, alice, { from: liquidator, gasPrice: GAS_PRICE  }))
    const liquidatorBalance_after_A = web3.utils.toBN(await erc20.balanceOf(liquidator))
    ...
    const liquidatorBalance_before_B = web3.utils.toBN(await erc20.balanceOf(liquidator))
    const B_GAS_Used_Liquidator = th.gasUsed(await troveManager.liquidate(assetAddress1, bob, { from: liquidator, gasPrice: GAS_PRICE  }))
    const liquidatorBalance_after_B = web3.utils.toBN(await erc20.balanceOf(liquidator))
    ...
    assert.isFalse(await th.checkRecoveryMode(contracts, assetAddress1))
    // Liquidate B (use 0 gas price to easily check the amount the compensation amount the liquidator receives)
    const liquidatorBalance_before_C = web3.utils.toBN(await erc20.balanceOf(liquidator))
    const C_GAS_Used_Liquidator = th.gasUsed(await troveManager.liquidate(assetAddress1, carol, { from: liquidator, gasPrice: GAS_PRICE  }))
    const liquidatorBalance_after_C = web3.utils.toBN(await erc20.balanceOf(liquidator))
  ...
  it('gas compensation from pool-offset liquidations: 0.5% collateral < $10 in value. Compensates $10 worth of collateral, liquidates the remainder', async () => {
    ...
    // A-E open troves
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(200, 18), extraParams: { from: alice} })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(120, 16)), extraKUSDAmount: dec(5000, 18), extraParams: { from: bob } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(60, 18)), extraKUSDAmount: dec(600, 18), extraParams: { from: carol } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(80, 18)), extraKUSDAmount: dec(1, 23), extraParams: { from: dennis } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(80, 18)), extraKUSDAmount: dec(1, 23), extraParams: { from: erin } })
  ...
  it('gas compensation from pool-offset liquidations: 0.5% collateral > $10 in value. Compensates 0.5% of  collateral, liquidates the remainder', async () => {
    ...
    // A-E open troves
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(2000, 18), extraParams: { from: alice,} })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(1875, 15)), extraKUSDAmount: dec(8000, 18), extraParams: { from: bob,} })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(600, 18), extraParams: { from: carol} })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(4, 18)), extraKUSDAmount: dec(1, 23), extraParams: { from: dennis} })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(4, 18)), extraKUSDAmount: dec(1, 23), extraParams: { from: erin} })
  ...
  it('Gas compensation from pool-offset liquidations. Liquidation event emits the correct gas compensation and total liquidated coll and debt', async () => {
    ...
    const { totalDebt: A_totalDebt } = await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(100, 18), extraParams: { from: alice } })
    const { totalDebt: B_totalDebt } = await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(200, 18), extraParams: { from: bob } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: dec(300, 18), extraParams: { from: carol } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: A_totalDebt, extraParams: { from: dennis } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(2, 18)), extraKUSDAmount: B_totalDebt, extraParams: { from: erin } })
    ...
    // Liquidate A (use 0 gas price to easily check the amount the compensation amount the liquidator receives)
    const liquidationTxA = await troveManager.liquidate(assetAddress1, alice, { from: liquidator, gasPrice: GAS_PRICE  })
    ...
    assert.isFalse(await th.checkRecoveryMode(contracts, assetAddress1))
    // Liquidate B (use 0 gas price to easily check the amount the compensation amount the liquidator receives)
    const liquidationTxB = await troveManager.liquidate(assetAddress1, bob, { from: liquidator, gasPrice: GAS_PRICE  })
  ...
  it('liquidateTroves(): full offset.  Compensates the correct amount, and liquidates the remainder', async () => {
    ...
    // A-F open troves
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(118, 16)), extraKUSDAmount: dec(2000, 18), extraParams: { from: alice } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(526, 16)), extraKUSDAmount: dec(8000, 18), extraParams: { from: bob } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(488, 16)), extraKUSDAmount: dec(600, 18), extraParams: { from: carol } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(545, 16)), extraKUSDAmount: dec(1, 23), extraParams: { from: dennis } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(10, 18)), extraKUSDAmount: dec(1, 23), extraParams: { from: erin } })
    await await openTrove({ asset: assetAddress1,ICR: toBN(dec(10, 18)), extraKUSDAmount: dec(1, 23), extraParams: { from: flyn } })
    ...
    */
    ...
    const liquidatorBalance_before = web3.utils.toBN(await erc20.balanceOf(liquidator))
    const GAS_Used_Liquidator = th.gasUsed(await troveManager.liquidateTroves(assetAddress1, 4, { from: liquidator, gasPrice: GAS_PRICE  }))
    const liquidatorBalance_after = web3.utils.toBN(await erc20.balanceOf(liquidator))
  ...
  it('liquidateTroves(): full offset. Liquidation event emits the correct gas compensation and total liquidated coll and debt', async () => {
    ...
    // A-F open troves
    const { totalDebt: A_totalDebt } = await await openTrove({ asset: assetAddress1,ICR: toBN(dec(118, 16)), extraKUSDAmount: dec(2000, 18), extraParams: { from: alice } })
    const { totalDebt: B_totalDebt } = await await openTrove({ asset: assetAddress1,ICR: toBN(dec(526, 16)), extraKUSDAmount: dec(8000, 18), extraParams: { from: bob } })
    const { totalDebt: C_totalDebt } = await await openTrove({ asset: assetAddress1,ICR: toBN(dec(488, 16)), extraKUSDAmount: dec(600, 18), extraParams: { from: carol } })
    const { totalDebt: D_totalDebt } = await await openTrove({ asset: assetAddress1,ICR: toBN(dec(545, 16)), extraKUSDAmount: dec(1, 23), extraParams: { from: dennis } })
    await await openTrove({ asset: assetAddress1,  ICR: toBN(dec(10, 18)), extraKUSDAmount: dec(1, 23), extraParams: { from: erin } })
    await await openTrove({ asset: assetAddress1,  ICR: toBN(dec(10, 18)), extraKUSDAmount: dec(1, 23), extraParams: { from: flyn } })
    ...
    */
    ...
    // Liquidate troves A-D
    const liquidationTxData = await troveManager.liquidateTroves(assetAddress1, 4, { from: liquidator, gasPrice: GAS_PRICE  })
  ...
  it('Trove ordering: same collateral, decreasing debt. Price successively increases. Troves should maintain ordering by ICR', async () => {
    ...
    for (const account of _10_accounts) {
      ...
      await await openTrove({ asset: assetAddress1,extraKUSDAmount: debtString, extraParams: { from: account, value: dec(30, 'ether') } })
    ...
    while (price < 210) {
      ...
      const gasComp_firstTrove = (await troveManager.getCollGasCompensation(assetAddress1, coll_firstTrove)).toString()
      ...
      for (account of _10_accounts) {
        ...
        const gasCompensation = (await troveManager.getCollGasCompensation(assetAddress1, coll)).toString()
  ...
  it('Trove ordering: increasing collateral, constant debt. Price successively increases. Troves should maintain ordering by ICR', async () => {
    ...
    for (const account of _20_accounts) {
      ...
      await openTrove({ asset: assetAddress1, assetSent: collString, extraKUSDAmount: dec(100, 18), extraParams: { from: account } })
  ...
  it('Trove ordering: Constant raw collateral ratio (excluding virtual debt). Price successively increases. Troves should maintain ordering by ICR', async () => {
    ...
    for (const coll of collVals) {
      ...
      const collString = coll.toString().concat('000000000000000000')
      await await openTrove({ asset: assetAddress1,extraKUSDAmount: dec(100, 18), extraParams: { from: account, value: collString } })
