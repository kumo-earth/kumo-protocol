...
contract("StabilityPool - KUMO Rewards", async accounts => {
  ...
  describe("KUMO Rewards", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct KUMO gain. No liquidations. Front ends and kickback rates.", async () => {
      ...
      assert.isAtMost(
        getDifference(await kumoToken.balanceOf(frontEnd_1), F1_expectedFinalGain),
        1e12
      );
      assert.isAtMost(
        getDifference(await kumoToken.balanceOf(frontEnd_2), F2_expectedFinalGain),
        1e12
      );
    });
    ...
    it("withdrawFromSP(): Depositors with varying initial deposit withdraw correct KUMO gain. Front ends and kickback rates", async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        dec(500, "ether"),
        th._100pct,
        await getOpenTroveKUSDAmount(assetAddress1, dec(50000, 18)),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      );
      ...
      assert.isAtMost(
        getDifference(A_KUMOGain_After_M2, A_expectedKUMOGain_M2.add(A_expectedKUMOGain_M1)),
        1e15
      );
      assert.isAtMost(
        getDifference(B_KUMOGain_After_M2, B_expectedKUMOGain_M2.add(B_expectedKUMOGain_M1)),
        1e15
      );
      assert.isAtMost(
        getDifference(C_KUMOGain_After_M2, C_expectedKUMOGain_M2.add(C_expectedKUMOGain_M1)),
        1e15
      );
      assert.isAtMost(
        getDifference(D_KUMOGain_After_M2, D_expectedKUMOGain_M2.add(D_expectedKUMOGain_M1)),
        1e15
      );
      ...
      assert.isAtMost(
        getDifference(F2_KUMOGain_After_M2, F2_expectedKUMOGain_M2.add(F2_expectedKUMOGain_M1)),
        1e15
      );
      ...
      assert.isAtMost(
        getDifference(
          A_KUMOGain_After_M3,
          A_expectedKUMOGain_M3.add(A_expectedKUMOGain_M2).add(A_expectedKUMOGain_M1)
        ),
        1e15
      );
      assert.isAtMost(
        getDifference(
          C_KUMOGain_After_M3,
          C_expectedKUMOGain_M3.add(C_expectedKUMOGain_M2).add(C_expectedKUMOGain_M1)
        ),
        1e15
      );
      assert.isAtMost(
        getDifference(
          D_KUMOGain_After_M3,
          D_expectedKUMOGain_M3.add(D_expectedKUMOGain_M2).add(D_expectedKUMOGain_M1)
        ),
        1e15
      );
      ...
      assert.isAtMost(
        getDifference(E_KUMOGain_After_M3, E_expectedKUMOGain_M3.add(E_expectedKUMOGain_M2)),
        1e15
      );
      ...
      assert.isAtMost(
        getDifference(B_KUMOBalance_After_M3, B_expectedKUMOGain_M2.add(B_expectedKUMOGain_M1)),
        1e15
      );

      // Expect F1 KUMO system gains to equal their gain from (M2 + M3)
      assert.isAtMost(
        getDifference(F1_KUMOGain_After_M3, F1_expectedKUMOGain_M3.add(F1_expectedKUMOGain_M2)),
        1e15
      );
      ...
      assert.isAtMost(
        getDifference(F2_KUMOBalance_After_M3, F2_expectedKUMOGain_M2.add(F2_expectedKUMOGain_M1)),
        1e15
      );
      ...
      const A_expectedFinalKUMOBalance = A_expectedKUMOGain_M1.add(A_expectedKUMOGain_M2)
        .add(A_expectedKUMOGain_M3)
        .add(A_expectedKUMOGain_M4);

      const B_expectedFinalKUMOBalance = B_expectedKUMOGain_M1.add(B_expectedKUMOGain_M2)
        .add(B_expectedKUMOGain_M3)
        .add(B_expectedKUMOGain_M4);

      const C_expectedFinalKUMOBalance = C_expectedKUMOGain_M1.add(C_expectedKUMOGain_M2)
        .add(C_expectedKUMOGain_M3)
        .add(C_expectedKUMOGain_M4);

      const D_expectedFinalKUMOBalance = D_expectedKUMOGain_M1.add(D_expectedKUMOGain_M2)
        .add(D_expectedKUMOGain_M3)
        .add(D_expectedKUMOGain_M4);

      const E_expectedFinalKUMOBalance =
        E_expectedKUMOGain_M2.add(E_expectedKUMOGain_M3).add(E_expectedKUMOGain_M4);

      const F1_expectedFinalKUMOBalance = F1_expectedKUMOGain_M1.add(F1_expectedKUMOGain_M2)
        .add(F1_expectedKUMOGain_M3)
        .add(F1_expectedKUMOGain_M4);

      const F2_expectedFinalKUMOBalance = F2_expectedKUMOGain_M1.add(F2_expectedKUMOGain_M2)
     ...
     */
      ...
      const expectedKUMOGain_A_and_B = kickbackRate
        .mul(issuance_M1)
        .div(toBN("2"))
      ...
      const expectedKUMOGain_C = kickbackRate
        .mul(issuance_M2)
      ...
      const expectedKUMOGain_D = kickbackRate
        .mul(issuance_M3)
      ...
      const expectedKUMOGain_E = kickbackRate
        .mul(issuance_M4)
      ...
      const expectedKUMOGain_F1 = toBN(dec(1, 18))
        .sub(kickbackRate)
