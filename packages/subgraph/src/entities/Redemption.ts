...
export function finishCurrentRedemption(
  ...
  _attemptedKUSDAmount: BigInt,
  _actualKUSDAmount: BigInt,
  _ETHSent: BigInt,
  _ETHFee: BigInt
): void {
  ...
  currentRedemption.tokensAttemptedToRedeem = decimalize(_attemptedKUSDAmount);
  currentRedemption.tokensActuallyRedeemed = decimalize(_actualKUSDAmount);
  currentRedemption.collateralRedeemed = decimalize(_ETHSent);
  currentRedemption.partial = _actualKUSDAmount < _attemptedKUSDAmount;
