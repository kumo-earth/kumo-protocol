 ...
 *
 * @remarks
 * Implemented by {@link @liquity/lib-ethers#PopulatedEthersKumoTransaction}.
 *
 * @public
 */
...
> {
   ...
   *
   * @returns An object that implements {@link @liquity/lib-base#SentKumoTransaction}.
   */
  send(): Promise<T>;
}
 ...
 *
 * When {@link @liquity/lib-base#PopulatableKumo.redeemKUSD | redeemKUSD()} is called with an
 ...
 *
 * Implemented by {@link @liquity/lib-ethers#PopulatableEthersKumo}.
 *
 * @public
 */
