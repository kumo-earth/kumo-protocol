 ...
 * {@link @liquity/lib-base#KUSD_MINIMUM_DEBT | minimum debt} requirement that Troves must fulfill,
 * some KUSD amounts are not possible to redeem exactly.
 *
 * When {@link @liquity/lib-base#PopulatableLiquity.redeemKUSD | redeemKUSD()} is called with an
 ...
 * {@link @liquity/lib-base#KUSD_MINIMUM_NET_DEBT}.
 *
 * @public
 */
...
export interface PopulatableLiquity<R = unknown, S = unknown, P = unknown>
  ...
  /** {@inheritDoc TransactableLiquity.borrowKUSD} */
  borrowKUSD(
    amount: Decimalish,
    maxBorrowingRate?: Decimalish
  ): Promise<
  ...
  /** {@inheritDoc TransactableLiquity.repayKUSD} */
  repayKUSD(
    amount: Decimalish
  ): Promise<
    PopulatedLiquityTransaction<
  ...
  /** {@inheritDoc TransactableLiquity.depositKUSDInStabilityPool} */
  ...
  /** {@inheritDoc TransactableLiquity.withdrawKUSDFromStabilityPool} */
  ...
  /** {@inheritDoc TransactableLiquity.sendKUSD} */
  sendKUSD(
    toAddress: string,
    amount: Decimalish
  ): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;
  ...
  /** {@inheritDoc TransactableLiquity.redeemKUSD} */
  redeemKUSD(
    amount: Decimalish,
    maxRedemptionRate?: Decimalish
  ): Promise<PopulatedRedemption<P, S, R>>;
