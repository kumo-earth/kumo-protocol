...
const Balances: React.FC = () => {
  ...
  return (
    <Box sx={{ mb: 3 }}>
      ...
      <Statistic name="ETH"> {accountBalance.prettify(0)}</Statistic>
      <Statistic name={COIN}> {kusdBalance.prettify(0)}</Statistic>
      <Statistic name={GT}>{kumoBalance.prettify(0)}</Statistic>
    </Box>
  );
};
