...
export interface KumoFaucet
  ...
  readonly filters: {
    ...
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    Transfer(from?: string | null, to?: string | null, ammount?: BigNumberish | null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "Transfer"): _TypedLogDescription<{ from: string; to: string; ammount: BigNumber }>[];
