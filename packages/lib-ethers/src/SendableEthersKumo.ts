...
/**
 * Ethers-based implementation of {@link @liquity/lib-base#SendableKumo}.
 *
 * @public
 */
export class SendableEthersKumo
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.openTrove} */
  async openTrove(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.closeTrove} */
  closeTrove(
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.adjustTrove} */
  adjustTrove(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.depositCollateral} */
  depositCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.withdrawCollateral} */
  withdrawCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.borrowKUSD} */
  borrowKUSD(
    amount: Decimalish,
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.repayKUSD} */
  repayKUSD(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.liquidate} */
  liquidate(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.liquidateUpTo} */
  liquidateUpTo(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.depositKUSDInStabilityPool} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.withdrawKUSDFromStabilityPool} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.withdrawGainsFromStabilityPool} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.transferCollateralGainToTrove} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.sendKUSD} */
  sendKUSD(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.sendKUMO} */
  sendKUMO(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.redeemKUSD} */
  redeemKUSD(
    amount: Decimalish,
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.claimCollateralSurplus} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.stakeKUMO} */
  stakeKUMO(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.unstakeKUMO} */
  unstakeKUMO(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.withdrawGainsFromStaking} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.registerFrontend} */
  registerFrontend(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.approveUniTokens} */
  approveUniTokens(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.stakeUniTokens} */
  stakeUniTokens(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.unstakeUniTokens} */
  unstakeUniTokens(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.withdrawKUMORewardFromLiquidityMining} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableKumo.exitLiquidityMining} */
  exitLiquidityMining(
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
